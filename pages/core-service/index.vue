  ...
  <div class="container">
    <div style="" class="zx-box">
      ...
      <div class="main-box row justify-content-between">
        <div
          class="left-box col-xl-3 col-12 wow animate__lightSpeedInLeft"
        ...
        <div
          class="right-box col-xl-8 col-12 wow animate__bounceInRight"
          data-wow-delay="100ms"
          data-wow-duration="2500ms">
          <div class="top-box">
            <h5>核心业务</h5>
          ...
          <div class="news-box">
            <div class="goods-nav">
              <img src="../../static/images/iFCB_lt_news.png" alt="" />
              <span>新闻资讯</span>
              <div>
                <a href="http://www.9tiaofu.com/news?pageNum=1" target="_blank">
                  更多
                  <i class="bi bi-chevron-right"></i>
                </a>
              </div>
            ...
            <ul class="ul-box">
              <li class="text-truncate">
                ...
                共青团安庆市委书记一行 莅临太湖县电商中心参观考察
                <i class="bi bi-chevron-right"></i>
              </li>
              <li class="text-truncate">
                <span>2023-01-11</span>
                固镇县副县长一行 莅临年货节活动现场检查指导
                <i class="bi bi-chevron-right"></i>
              </li>
